...
As a result, IGARCH is specifically designed to capture non-stationary processes, with the persistence of the volatility shocks lasting indefinitely; therefore, it might provide better forecasts for non-stationary volatilities.
...
\begin{equation}
\begin{aligned}
X_t &= 0.000134 + \epsilon_t \\
\epsilon_t &= \sigma_t z_t \\
\sigma_t^2 &= 0 + 0.046422 \cdot \epsilon_{t-1}^2 + 0.953578 \cdot \sigma_{t-1}^2
\end{aligned}
\end{equation}
$$

Further, notably, the alpha1 coefficient is statistically significant with a p-value of 0.00000, indicating that past volatility has a significant impact on current volatility.
...
\begin{equation}
\begin{aligned}
X_t &= 0.000356 + \epsilon_t \\
\epsilon_t &= \sigma_t z_t \\
\sigma_t^2 &= 0 + 0.046147 \cdot \epsilon_{t-1}^2 + 0.953853 \cdot \sigma_{t-1}^2 \\
z_t &\sim t(5.235451)
\end{aligned}
\end{equation}
$$
